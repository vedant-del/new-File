            ...
            <div className="get-in-touch">
                <div className="col-lg-4 col-md-12 pt-5 mb-5">
                  ...
                  <div className="d-flex mb-2">
                    <p className="mb-0"> <MdOutlineLocationOn />123 Street, Abc State, india</p>
                  </div>
                  <div className="d-flex mb-2">
                    <p className="mb-0"><HiOutlineMailOpen />info@example.com</p>
                  </div>
                  <div className="d-flex mb-2">
                    <p className="mb-0"><BiPhoneCall />+012 345 67890</p>
                  </div>
                ...
                <div className="Quick-Links">
                  ...
                  <div className="link-animated d-flex">
                    <a className="text-light arrow mb-2" to="/">
                        <BsArrowRight />
                      Home
                    </a>
                    <a className="text-light arrow mb-2" to="/about">
                    <BsArrowRight />
                      About Us
                    </a>
                    <a className="text-light arrow mb-2" to="/service">
                    <BsArrowRight />Our
                      Services
                    </a>
                    ...
                    <a className="text-light arrow" to="/contact">
                    <BsArrowRight />
                      Contact Us
                    </a>
                  </div>
